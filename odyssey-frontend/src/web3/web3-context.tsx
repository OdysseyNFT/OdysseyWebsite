...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({children}) => {
    ...
    const [uri, setUri] = useState("https://eth-mainnet.alchemyapi.io/v2/_4CHI_DeGdhxoxeRVTESlB3pzZ4prHyA");
        ...
        let modal = new Web3Modal({
            ...
            providerOptions: {
                walletconnect: {
                    ...
                    options: {
                        rpc: {
                            [Networks.MAINNET]: "https://eth-mainnet.alchemyapi.io/v2/_4CHI_DeGdhxoxeRVTESlB3pzZ4prHyA",
                            [Networks.FTM_TESTNET]: "https://rpc.testnet.fantom.network/",
